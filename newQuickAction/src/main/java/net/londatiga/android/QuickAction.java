...
public class QuickAction extends PopupWindows {
	...
	public static final int ANIM_MOVE_FROM_RIGHT = 5;
	...
	public void addActionItem(ActionItem action) {
		...
		container.findViewById(R.id.item).setOnClickListener(new OnClickListener() {
			@Override
	...
	public void show (View anchor) {
		...
		showArrow(((onTop) ? R.id.arrow_down : R.id.arrow_up), anchorRect.centerX()  - (screenWidth - rootWidth) / 2);
		
		View container = mRootView.findViewById(R.id.slider_container);
		int containerWidth = container.getMeasuredWidth();
		if(anchorRect.centerX() > xPos + containerWidth) {
			xPos = anchorRect.centerX() - containerWidth + mArrowUp.getMeasuredWidth();
			showArrow(((onTop) ? R.id.arrow_down : R.id.arrow_up), containerWidth - mArrowUp.getMeasuredWidth());
		}
	...
	public void show (View anchor, long id) {
		mItemId = id;
		show(anchor);
	}
	...
	private void setAnimationStyle(int screenWidth, int requestedX, boolean onTop) {
		...
		case ANIM_MOVE_FROM_RIGHT:
			mWindow.setAnimationStyle((onTop) ? R.style.Animations_PopUpMenu_MoveRight : R.style.Animations_PopDownMenu_MoveRight);
		break;
