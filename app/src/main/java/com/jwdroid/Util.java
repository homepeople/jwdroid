...
public class Util {
    ...
    static public String pluralForm6(int n, String form1, String form2, String form5) {
        n = Math.abs(n) % 100;
        int n1 = n % 10;
        if (n1 == 1 && n != 11) return form1;
        if (n1 == 0 || n >= 11 && n <= 19) return form2;
        return form5;
    }
    ...
    static public String pluralForm(Context context, int n, String[] forms) {
        ...
        if (locale.equals("lt"))
            return pluralForm6(n, forms[0], forms[1], forms[2]);
        else
